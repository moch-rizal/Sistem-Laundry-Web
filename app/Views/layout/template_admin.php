...
<head>
    ...
    <meta name="description" content="Sistem Informasi Laundry">
    <meta name="author" content="Anda">

    <title><?= $this->renderSection('title') ?> | Admin Laundry</title>
    ...
    <!-- Custom styles for this page (misal: untuk tabel) -->
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/dashboard">
                ...
                <div class="sidebar-brand-text mx-3">LAUNDRY <sup>Admin</sup></div>
            </a>
            ...
            <!-- Nav Item - Pesanan -->
            <li class="nav-item">
                <a class="nav-link" href="/admin/pesanan"> <!-- Nanti kita isi linknya -->
                    <i class="fas fa-fw fa-shopping-cart"></i>
                    <span>Manajemen Pesanan</span></a>
            </li>

             <!-- Nav Item - Pelanggan -->
            <li class="nav-item">
                <a class="nav-link" href="/admin/pelanggan"> <!-- Nanti kita isi linknya -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright © Sistem Laundry <?= date('Y') ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
